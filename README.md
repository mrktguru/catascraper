...
- **Название** - полное название лота
- **Фото** - все изображения товара
- **Количество бутылок** - количество бутылок в лоте
- **Продавец** - имя продавца
- **Текущая цена** - текущая ставка/цена
...
├── advanced_scraper.py     # Продвинутый scraper (рекомендуется)
